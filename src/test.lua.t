...
@step_in_debug_session+=
for i=1,11 do
  vim.rpcnotify(debug_neovim_conn, "nvim_feedkeys", ':lua require"dap".step_into()\n', "n", false)
  vim.wait(500)
end

@next_in_debug_session+=
vim.rpcnotify(debug_neovim_conn, "nvim_feedkeys", ':lua require"dap".step_over()\n', "n", false)
vim.wait(500)
vim.rpcnotify(debug_neovim_conn, "nvim_feedkeys", ':lua require"dap".step_over()\n', "n", false)
vim.wait(500)
...
@step_out_debug_session+=
vim.rpcnotify(debug_neovim_conn, "nvim_feedkeys", ':lua require"dap".step_out()\n', "n", false)
vim.wait(500)

@test_hover_debug_session+=
vim.rpcnotify(debug_neovim_conn, "nvim_win_set_cursor", 0, {3, 6})
vim.wait(100)
vim.rpcnotify(debug_neovim_conn, "nvim_feedkeys", ':lua require"dap.ui.variables".hover()\n', "n", false)
vim.wait(100)

@test_repl+=
vim.rpcnotify(debug_neovim_conn, "nvim_feedkeys", ':lua require"dap".repl.open()\n', "n", false)
vim.wait(200)
vim.rpcnotify(debug_neovim_conn, "nvim_exec", "wincmd p", false)
vim.wait(200)
vim.rpcnotify(debug_neovim_conn, "nvim_feedkeys", 'i2*a\n', "n", false)
vim.wait(200)
vim.rpcnotify(debug_neovim_conn, "nvim_feedkeys", '10+10\n', "n", false)
vim.wait(200)

local results = vim.rpcrequest(debug_neovim_conn, "nvim_buf_get_lines", 0, 0, -1, true)
...
vim.rpcnotify(debug_neovim_conn, "nvim_feedkeys", ':lua require"dap".continue()\n', "n", false)
vim.wait(50)
vim.rpcnotify(debug_neovim_conn, "nvim_feedkeys", ':lua require"dap".pause(1)\n', "n", false)
vim.wait(200)

@test_disconnect_session+=
vim.wait(50)
vim.rpcnotify(debug_neovim_conn, "nvim_feedkeys", ':lua require"dap".disconnect()\n', "n", false)
